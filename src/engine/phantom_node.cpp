...
PhantomNode::PhantomNode()
    : forward_node_id(SPECIAL_NODEID), reverse_node_id(SPECIAL_NODEID),
      ...
      reverse_name_id(std::numeric_limits<unsigned>::max()), forward_weight(INVALID_EDGE_WEIGHT),
...
{
    return location.IsValid() && (name_id != INVALID_NAMEID) && (reverse_name_id != INVALID_NAMEID);
}
